...
func TestFullTypeName_type(t *testing.T) {
	...
	expected := "github.com/hashicorp/terraform-provider-aws/external/framework/flex.emptyStruct"
...
func TestFullTypeName_mapTypedKeyPrimitiveValue(t *testing.T) {
	...
	expected := "map[github.com/hashicorp/terraform-provider-aws/external/framework/flex.testEnum]string"
...
func TestFullTypeName_mapPrimitiveKeyTypedValue(t *testing.T) {
	...
	expected := "map[string]github.com/hashicorp/terraform-provider-aws/external/framework/flex.testEnum"
