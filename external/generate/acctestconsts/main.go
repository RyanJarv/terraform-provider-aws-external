...
func main() {
	const (
		constsFilename       = "../../../external/acctest/consts_gen.go"
		constOrQuoteFilename = "../../../external/acctest/generate/const_or_quote_gen.go"
		semgrepFilename      = "../../../.ci/.semgrep-test-constants.yml"
		constantDataFile     = "../../../external/acctest/consts.csv"
	)
